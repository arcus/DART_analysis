...
# combine pre and post into a single tidy data frame
...
pathways <- readr::read_csv(here::here("pathway_assignments.csv"))
```
...
saveRDS(data, file = here::here("data", "interim", "data_for_hyp_testing.rds"))
```
