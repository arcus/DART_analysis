...
data |> 
  ...
  gt::gtsave( # save table as image
    filename = "consented_participant_n_by_phase.png",
    path = here::here("reports", "tables"))

knitr::include_graphics(here::here("reports", "tables", "consented_participant_n_by_phase.png"))
```
...
data |> 
  ...
  gtsummary::as_gt() |> # convert to gt table
  gt::gtsave( # save table as image
    filename = "consented_participant_n_by_chop.png",
    path = here::here("reports", "tables"))

knitr::include_graphics(here::here("reports", "tables", "consented_participant_n_by_chop.png"))
```
...
data |> 
  ...
  gtsummary::as_gt() |> # convert to gt table
  gt::gtsave( # save table as image
    filename = "consented_participant_n_by_phase_chop.png",
    path = here::here("reports", "tables"))

knitr::include_graphics(here::here("reports", "tables", "consented_participant_n_by_phase_chop.png"))
```
