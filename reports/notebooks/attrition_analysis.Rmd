...
### Additional half-baked thoughts

An important future direction of this and related work is reducing attrition in online learning programs

One benefit of learning programs with a more demanding structure (e.g. in-person class time) may be that the increase in accountability and the knowledge that they've made a higher investment

An important future direction for this work would be a study designed to assess causality, such as a randomized control trial, with careful attention to attrition. 

It is impossible for us to know if learners who failed to complete the post-test surveys would have reported the same kinds of favorable ratings we saw from learners who did complete the program -- likely not. 


Nevertheless, a reasonable guess would be that the participants who did take the time to complete the post-test surveys found the training more useful on average than those who did not, introducing bias. 

Although we cannot estimate the bias directly because the necessary information is by definition in the missing post-test data, we can look for systematic differences at pretest between learners who do and don't go on to complete the post-test. 
We have only very limited data on the learners at pretest, but the comparisons we are able to run do not reveal significant differences between learners who go on to complete the program vs. not in either pretest scores or responses to the needs assessment survey (see Appendix ##); although there's a suggestion of a trend in the Wave 1 data such that learners who report higher average expertise and higher average interest in learning on the needs assessment survey may be more likely to complete the program, that effect is not at all present in the Wave 2 data. 
