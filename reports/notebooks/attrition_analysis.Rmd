...
(needs_asssessment_and_attrition |> 
  ...
  save_and_print(filename = "attrition_needsassessment.tiff",
                 width = 6,
                 height = 6)
```
...
(combined_data_long |> 
  ...
  # the save_and_print function is defined in functions_plotting.R
  save_and_print(filename = "active_past_day_1_needsassessment.tiff",
                 width = 6,
                 height = 6)
...
(combined_data_long |> 
  ...
  # the save_and_print function is defined in functions_plotting.R
  save_and_print(filename = "active_past_day_1_pretest.tiff",
                 width = 6,
                 height = 6)
...
(combined_data_long |> 
  ...
  # the save_and_print function is defined in functions_plotting.R
  save_and_print(filename = "active_past_day_1_posttest.tiff",
                 width = 6,
                 height = 6)
...
(combined_data_long |> 
  ...
  # the save_and_print function is defined in functions_plotting.R
  save_and_print(filename = "active_past_day_1_exit.tiff",
                 width = 6,
                 height = 6)
```
